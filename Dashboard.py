...
def predictor():
	...
	if result[0][0] == 1:
		  ...
		  return 'Additional Services Availability'
	elif result[0][12] == 1:
		  return 'M'
	elif result[0][13] == 1:
		  return 'N'
		  ...
		  return 'Book a table for Restaurant'
	elif result[0][19] == 1:
		  return 'T'
	elif result[0][20] == 1:
		  return 'U'
...
class Dashboard(QtWidgets.QMainWindow):
	def __init__(self):
		...
		self.title = 'Hotel Balaji Bhavan'
		...
		self.label_3.setGeometry(75,160,780,441)
		movie.start()
